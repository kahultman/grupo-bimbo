...
save(train, file = "data/rdf/train.Rdata")
save(train2, file = "data/rdf/train2.Rdata")
save(validate, file = "data/rdf/validate.Rdata")
save(test, file = "data/rdf/test.Rdata")
save(clients, file = "data/rdf/clients.Rdata")
save(products, file = "data/rdf/products.Rdata")
save(town_state, file = "data/rdf/town_state.Rdata")
